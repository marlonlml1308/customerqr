...
<body class="bg-gray-900 text-white">
  <div class="max-w-md mx-auto mt-10 p-6">
    ...
    <div class="flex justify-center mb-4">
      <img src="https://sotocoffee.com.co/wp-content/uploads/2020/11/SotoCoffeeLogoBlanco-300x300.png" alt="Logo" class="h-32">
    </div>
    ...
    <form action="{{ route('clientes.store') }}" method="POST" id="demo-form">
      ...
      <!-- Campo: Nombre (máximo 50 caracteres) -->
        ...
        <div class="relative text-gray-500 focus-within:text-gray-300">
          <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
            ...
            <svg class="stroke-current" width="24" height="24" viewBox="0 0 24 24" fill="none"
              ...
              <path d="M19 21v-2c0-2.761-2.239-5-5-5H10c-2.761 0-5 2.239-5 5v2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
      ...
      <div class="relative mb-6">
        ...
        <div class="relative text-gray-500 focus-within:text-gray-300">
          <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
            ...
            <svg class="stroke-current" width="24" height="24" viewBox="0 0 24 24" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path d="M6 2H14L20 8V22C20 22.5304 19.7893 23.0391 19.4142 23.4142C19.0391 23.7893 18.5304 24 18 24H6C5.46957 24 4.96086 23.7893 4.58579 23.4142C4.21071 23.0391 4 22.5304 4 22V4C4 3.46957 4.21071 2.96086 4.58579 2.58579C4.96086 2.21071 5.46957 2 6 2Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <div class="relative mb-6">
        ...
        <div class="relative text-gray-500 focus-within:text-gray-300">
          ...
          <select name="tipo_documento" id="tipo_documento"
            class="block w-full h-11 pr-5 pl-12 py-2.5 text-base font-normal shadow-xs text-gray-100 bg-gray-800 border border-gray-600 rounded-full placeholder-gray-500 focus:outline-none" required>
      ...
      <!-- Campo: Correo Electrónico con regex pattern -->
      <div class="relative mb-6">
        ...
        <div class="relative text-gray-500 focus-within:text-gray-300">
          <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
            ...
            <svg class="stroke-current" width="24" height="24" viewBox="0 0 24 24" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path d="M4 4H20C21.1046 4 22 4.89543 22 6V18C22 19.1046 21.1046 20 20 20H4C2.89543 20 2 19.1046 2 18V6C2 4.89543 2.89543 4 4 4Z" stroke="currentColor"
                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <!-- Campo: Dirección (opcional, máximo 50 caracteres) -->
      <div class="relative mb-6">
        <label for="direccion" class="flex items-center mb-2 text-gray-300 text-sm font-medium">
          Dirección (opcional)
        </label>
        <div class="relative text-gray-500 focus-within:text-gray-300">
          <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
            ...
            <svg class="stroke-current" width="24" height="24" viewBox="0 0 24 24" fill="none"
              ...
              <circle cx="12" cy="9" r="2.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                stroke-linejoin="round"/>
            </svg>
          </div>
          <input type="text" name="direccion" id="direccion" value="{{ old('direccion') }}"
            class="block w-full h-11 pr-5 pl-12 py-2.5 text-base font-normal shadow-xs text-gray-100 bg-gray-800 border border-gray-600 rounded-full placeholder-gray-500 focus:outline-none"
            placeholder="Ingrese dirección (opcional)" maxlength="50">
        </div>
      </div>
  ...
  <script>
    // Captura el evento submit del formulario y obtiene el token de reCAPTCHA v3
